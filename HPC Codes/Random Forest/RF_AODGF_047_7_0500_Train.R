...
dataset2 <- dataset[,c(response_var1,predictor_vars)]
...
model <- ranger(
  formula = as.formula(paste(response_var1, "~ .")),
  data = train_set,
  mtry = 7,
  num.trees = 500,
...
saveRDS(model, "/mnt/isilon/vub1/HaSET/Cluster/Models/RF_AODGapFill_047_7_0500_Train.rds") 
