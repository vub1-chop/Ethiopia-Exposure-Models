...
meteosat <- read.csv("/Users/lenovo/Desktop/HaSET/processing/grids/Meteosat_LSE_StudyRegion.csv",as.is=T)
...
for (i in 1:length(year)){
  b = read_stars(paste0("/Users/lenovo/Desktop/HaSET/meteosat/LSE/PRODUCTS/MSG/MEM/NETCDF/",year[i],"/",month[i],"/",day[i],"/NETCDF4_LSASAF_MSG_EMMAPS_MSG-Disk_",year[i],month[i],day[i],"0000.nc"), quiet = TRUE)
  dat <- nc_open(paste0("/Users/lenovo/Desktop/HaSET/meteosat/LSE/PRODUCTS/MSG/MEM/NETCDF/",year[i],"/",month[i],"/",day[i],"/NETCDF4_LSASAF_MSG_EMMAPS_MSG-Disk_",year[i],month[i],day[i],"0000.nc"))
  ...
  saveRDS(a3, file = paste0("/Users/lenovo/Desktop/HaSET/processing/Meteosat_LSE/",year[i],"/Ethiopia_Processed_Meteosat_LSE_StudyRegion_250m_",year[i],month[i],day[i],".rds"))
