...
for (i in 291:length(year)){
  
  # Read in Meteosat grid; need "foreign" library to read dbf from shapefile
  meteosat <- read.csv("/Users/lenovo/Desktop/HaSET/processing/grids/Meteosat_LST_StudyRegion.csv",as.is=T)
  
  # LST for each day
  Dir <-paste0("/Users/lenovo/Desktop/HaSET/meteosat/LST/PRODUCTS/MSG/MLST-ASv2/NETCDF/",year[i],"/",month[i],"/",day[i],"/")
  ...
  saveRDS(a3, file = paste0("/Users/lenovo/Desktop/HaSET/processing/Meteosat_LST/",year[i],"/Ethiopia_Processed_Meteosat_LST_StudyRegion_250m_",year[i],month[i],day[i],".rds"))
