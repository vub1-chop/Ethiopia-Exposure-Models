...
meteosat <- read.csv("D:/HaSET/Codes/grids/Meteosat_LAI_StudyRegion.csv",as.is=T)
...
for (i in 1:length(year)){
  b = read_stars(paste0("D:/HaSET/Raw_NC/Meteosat_LAI/PRODUCTS/MSG/MDILAI/NETCDF/",year[i],"/",month[i],"/",day[i],"NETCDF4_LSASAF_MSG_LAI_MSG-Disk_",year[i],month[i],day[i],"0000.nc"), quiet = TRUE)
  dat <- nc_open(paste0("D:/HaSET/Raw_NC/Meteosat_LAI/PRODUCTS/MSG/MDILAI/NETCDF/",year[i],"/",month[i],"/",day[i],"/NETCDF4_LSASAF_MSG_LAI_MSG-Disk_",year[i],month[i],day[i],"0000.nc"))
  ...
  saveRDS(a3, file = paste0("D:/HaSET/Processed/Meteosat_LAI/",year[i],"/Ethiopia_Processed_Meteosat_LAI_StudyRegion_250m_",year[i],month[i],day[i],".rds"))
