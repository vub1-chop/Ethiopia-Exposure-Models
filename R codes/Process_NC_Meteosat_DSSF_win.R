...
# test code
# dat <- nc_opecn("/Users/lenovo/Desktop/HaSET/meteosat/DSSF/PRODUCTS/MSG/MEM/NETCDF/2018/01/01/NETCDF4_LSASAF_MSG_EMMAPS_MSG-Disk_201801010000.nc")
...
for (i in 1:length(year)){
  b = read_stars(paste0("D:/HaSET/Raw_NC/Meteosat_DSSF/PRODUCTS/MSG/MDIDSSF/NETCDF/",year[i],"/",month[i],"/",day[i],"/NETCDF4_LSASAF_MSG_DIDSSF_MSG-Disk_",year[i],month[i],day[i],"0000.nc"), quiet = TRUE)
  dat <- nc_open(paste0("D:/HaSET/Raw_NC/Meteosat_DSSF/PRODUCTS/MSG/MDIDSSF/NETCDF/",year[i],"/",month[i],"/",day[i],"/NETCDF4_LSASAF_MSG_DIDSSF_MSG-Disk_",year[i],month[i],day[i],"0000.nc"))
  ...
  saveRDS(a3, file = paste0("D:/HaSET/Processed/Meteosat_DSSF/",year[i],"/Ethiopia_Processed_Meteosat_DSSF_StudyRegion_250m_",year[i],month[i],day[i],".rds"))
