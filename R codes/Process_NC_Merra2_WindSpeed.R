...
Dir <-paste("E:/Bryan/Projects/Ethiopia/Merra2/WindSpeed/Raw/",sep="")
# Get file names
...
for (fi in 1:length(file1)){
  ...
  times <- as.POSIXct("2018-01-01 00:30:00")+as.difftime(ncvar_get(dat, "time"),units="mins")
  ...
  saveRDS(a3, file = paste0("E:/Bryan/Projects/Ethiopia/Merra2/WindSpeed/Processed/Ethiopia_Processed_Merra2_StudyRegion_250m_WindSpeed_",year[fi],"_",month[fi],"_",day[fi],".rds"))
