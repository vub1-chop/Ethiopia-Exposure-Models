...
for (i in 170:length(year)){
  ...
  # MH for each day
  Dir <-paste0("D:/HaSET/Raw_NC/Meteosat_MH/",year[i],"/",month[i],"/",day[i],"/")
  ...
  saveRDS(a3, file = paste0("D:/HaSET/Processed/Meteosat_MH/",year[i],"/Ethiopia_Processed_Meteosat_MH_StudyRegion_250m_",year[i],month[i],day[i],".rds"))
