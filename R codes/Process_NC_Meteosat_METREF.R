...
meteosat <- read.csv("/Users/lenovo/Desktop/HaSET/processing/grids/Meteosat_METREF_StudyRegion.csv",as.is=T)
...
for (i in 1:length(year)){
  b = read_stars(paste0("/Users/lenovo/Desktop/HaSET/meteosat/METREF/PRODUCTS/MSG/METREF/NETCDF/",year[i],"/",month[i],"/",day[i],"/NETCDF4_LSASAF_MSG_METREF_MSG-Disk_",year[i],month[i],day[i],"0000.nc"), quiet = TRUE)
  dat <- nc_open(paste0("/Users/lenovo/Desktop/HaSET/meteosat/METREF/PRODUCTS/MSG/METREF/NETCDF/",year[i],"/",month[i],"/",day[i],"/NETCDF4_LSASAF_MSG_METREF_MSG-Disk_",year[i],month[i],day[i],"0000.nc"))
...
colnames(a3) <- c("FID","X","Y","X_Pro","Y_Pro", "METREF")
  ...
  saveRDS(a3, file = paste0("/Users/lenovo/Desktop/HaSET/processing/Meteosat_METREF/",year[i],"/Ethiopia_Processed_Meteosat_METREF_StudyRegion_250m_",year[i],month[i],day[i],".rds"))
